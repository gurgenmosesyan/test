...
$dictionary.initSearchPage = function() {
    var actions = {
        ...
        "render": function(data) {
            return  '<div class="text-center">'+
                        '<a href="/admpanel/dictionary/edit/'+data.id+'" class="action-edit">'+
    ...
    $dictionary.table = $('#data-table').DataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": '/admpanel/dictionary?app='+$dictionary.appId,
            "type": "post",
            "data": {
                '_token': $main.token
            }
...
$dictionary.deleteObj = function(key) {
    $.ajax({
        type: 'post',
        url: '/admpanel/dictionary/delete',
        data: {
            key: key,
...
$dictionary.initApp = function() {
    $('#app-select').change(function() {
        document.location.href = '/admpanel/dictionary?app='+$(this).val();
    });
};
