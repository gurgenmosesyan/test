...
<form id="edit-form" class="form-horizontal" method="post" action="{{$url}}">
    <div class="box-body">
        <div class="form-group">
            <label class="col-sm-2 control-label data-req">{{trans('admin.base.label.name')}}</label>
            <div class="col-sm-10">
                <input type="text" name="name" class="form-control" value="{{$language->name or ''}}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="text" name="code" class="form-control" value="{{$language->code or ''}}">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="checkbox" name="default" class="minimal-checkbox" value="{{Language::DEFAULT_LNG}}" {{$language->default == Language::DEFAULT_LNG ? ' checked="checked"' : ''}}>
