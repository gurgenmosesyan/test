            ...
            @foreach($autos as $key => $auto)
                ...
                <a href="{{url_with_lng('/auto/'.$auto->auto_id, false)}}" class="auto db">
                    <span class="auto-img db fl">
                        <img src="{{$auto->images[0]->getImage()}}" width="205" />
                    </span>
                    <span class="auto-info db fl">
                        <span class="title-box db fl">
                            ...
                            <span class="details db">
                                2.4 (200 l.s.) gasoline, peredniy privod, sedan, krasniy
                            </span>
                        ...
                        <span class="mileage db fr">
                            {{$auto->mileage_measurement == Auto::MILEAGE_MEASUREMENT_KM ? $auto->mileage_km : $auto_mile}}
